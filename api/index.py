...
def get_github_content():
    all_projects = [
        ...
        },
        {
            ...
            "svg": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="36" height="36"><defs><mask id="pasha-hole"><rect width="512" height="512" fill="white" /><circle cx="256" cy="256" r="32" fill="black" /></mask></defs><g mask="url(#pasha-hole)" fill="#00e5ff"><rect x="232" y="16" width="48" height="480" rx="12" /><rect x="232" y="16" width="48" height="480" rx="12" transform="rotate(45 256 256)" /><rect x="232" y="16" width="48" height="480" rx="12" transform="rotate(90 256 256)" /><rect x="232" y="16" width="48" height="480" rx="12" transform="rotate(135 256 256)" /><circle cx="256" cy="256" r="168" fill="none" stroke="#00e5ff" stroke-width="48" /><circle cx="256" cy="256" r="56" fill="none" stroke="#00e5ff" stroke-width="48" /></g></svg>'''
        },
        {
            "id": "zendrift",
            "title": "ZenDrift",
